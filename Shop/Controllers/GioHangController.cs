...
namespace Shop.Controllers
{
    ...
    {
        private readonly ShopContext data;
        private readonly IWebHostEnvironment _env;
        public GioHangController(ShopContext context, IWebHostEnvironment env)
        {
            data = context;
            _env = env;
        }
        ...
        public IActionResult DatHang([FromForm] FormCollection collection)
        {
            ...
            string senderEmail = "shopthucunghutech@gmail.com";
            ...
            // Send email to admin
            string senderEmailAdmin = "shopthucunghutech@gmail.com";
